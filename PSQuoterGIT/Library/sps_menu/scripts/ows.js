...
function RTE_DD_GenerateMenuItemHtml(cColumns, iMenuItem, strCommandToPerform, strCommandValue, strMenuItemHtml, strMenuItemToolTip)
{
	...
	strHtmlRet += "<td class=\"ms-toolbar " + g_strRTEUnselectedClassName + "\" nowrap id=\"" + g_strRTEMenuItemBaseName + iMenuItem + "\" " +
			...
			"\" style=\"text-decoration: none; color: black; cursor:pointer;\" title=\"" + strMenuItemToolTip + "\" onblur=\"RTE_DD_Item_OnBlur()\" onfocus=\"RTE_DD_Item_OnFocus(this.parentElement)\" >" +
...
function CalStBuildDHTML()
{
	...
	if (this.iperiod == 2 )
		...
		st += '<tr>' + stTDHigh + StClickEvent(this.stObject + '.MoveDate(-1)') + ' class=ms-calhead style="cursor:pointer;" width=8%>&lt;</th><th width=84% class=ms-calhead nowrap>' +
			this.StDayMonthYear() +
			'</th>' + stTDHigh + StClickEvent(this.stObject + '.MoveDate(1)') + ' class=ms-calhead style="cursor:pointer;" width=8%>&gt;</th></tr>';
		if (cNoTime > 0)
			{
		...
		for (irw = 0; irw < this.irwMax; irw++)
			...
			for (iday = 0; iday < 7; iday++)
				...
				st += '<td class=ms-calTop' + this.DayStyle(dateCur, false, true, fWeekly) +
					'>&nbsp;<span style="cursor:pointer;" onmouseover="HighlightText(this, \'red\');" onmouseout="HighlightText(this, \'\');"' + StClickEvent(this.stObject + ".MoveToDay(" + dateCur.getUTCFullYear() + "," + (dateCur.getUTCMonth()+1) + "," + dateCur.getUTCDate() + ")") + ">" + dateCur.getUTCDate() + "</span>&nbsp;</td>\r";
				}
			st += "</tr>\r";
			for (ichan = 0; ichan < cchan; ichan++)
				{
					...
					if (ichan == cchan-1 && this.SpanCheck(irw, iday, ichan, cchan)) 
						{
							...
							'><span style="cursor:pointer;" onmouseover="HighlightText(this, \'red\');" onmouseout="HighlightText(this, \'\');"' + StClickEvent(this.stObject + ".MoveToDay(" + dateCur.getUTCFullYear() + "," + (dateCur.getUTCMonth()+1) + "," + dateCur.getUTCDate() + ")") +
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFJ7T8ljGyBCC
// SIG // CToKFmfwVkNGqag4oIIUvDCCArwwggIlAhBKGdI4jIJZ
...
// SIG // DAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUnLFi
// SIG // auVZyLhs/lW3AijF+mgWrpkwQAYKKwYBBAGCNwIBDDEy
// SIG // MDCgDoAMAG8AdwBzAC4AagBzoR6AHGh0dHA6Ly9vZmZp
// SIG // Y2UubWljcm9zb2Z0LmNvbSAwDQYJKoZIhvcNAQEBBQAE
// SIG // ggEAmnLfyhFObscpPUNlHmcc5KO0+kMhdFg3CE64mbDb
// SIG // p/oDp5xjQbZ/XWEGJ1Ro0aAmm+2FVkDIb8/xBlTfKgzI
// SIG // jqWFCjleTHfdUw1nG5XZSHy5kGDRATH6bZ8rW30Sp2CC
// SIG // 3HbasUxeRshZyzO2wVt4dIDB0dh3dEInHx6Ee89EyaOv
// SIG // ZmV6JOwrO0z6X396+mbiQJqp5G8yoWn4vHiAGrCHVz3C
// SIG // hEC1hLXTQy4sZfp2VprU1DlMaWiReViO1M0iOfXJcPQY
// SIG // xMSP4EwFezV8oVx2Jq5Qa/vfwDNNZZJJUhLzDUyjuYan
// SIG // S5Iwi4UZ3bWt4Q2NQyU2jaCbFUYsCYU/OdpjPKGCAkww
...
// SIG // Fw0wMzA3MTUwNjA1MDhaMB8GCSqGSIb3DQEJBDESBBC0
// SIG // Atw7LWkEYzsQzcWEJsrZMA0GCSqGSIb3DQEBAQUABIIB
// SIG // ACQbIOcYTaqbA10WEs6GjeYfsZUM5hznmFh7Il5Nvg6h
// SIG // +ZhUZ0MXOqeGwQPxWUFY/KfK0L5OlvmxN9MEkKHzC+wj
// SIG // VqMY1NHndtbdjvJF9O6Bl2ffl8hx7h8l1iLucIkMgP58
// SIG // drWW1t3NUYv4bZdyUcweNvj5IgZ5QAMcjOvq4YIY0ywf
// SIG // zSj+q0EdIUPq9CxOLLYNitQ1JFBnfzPZOdTmkwtXpjTW
// SIG // ZXV2+Vjh9t5UonSgdg/QvzCSgP98zLLuCcELFRhUfIn4
// SIG // gLdM/XFI7ZIWWV016yAdmb+YP/UNYSGDxUQ4fH8PhMnD
// SIG // 8SjRDkMq5vAJ6+29l4YdhBAawHLQQ/vNuAw=
